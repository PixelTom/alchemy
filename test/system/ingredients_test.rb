...
class IngredientsTest < ApplicationSystemTestCase
  ...
  test "creating a Ingredient" do
    ...
    fill_in "Element", with: @ingredient.element
    fill_in "Influence", with: @ingredient.influence
    fill_in "Lb", with: @ingredient.lb
    fill_in "Name", with: @ingredient.name
    fill_in "Oz", with: @ingredient.oz
    fill_in "Rarity", with: @ingredient.rarity
